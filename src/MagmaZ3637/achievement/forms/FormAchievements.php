...
class FormAchievements
{
    ...
    public function getFormAchievements(Player $player)
    {
        $form = new SimpleForm(function (Player $player, $data) {
            ...
            switch($data) {
                ...
                break;
                case 2:
                    $player->sendMessage("§a[MAchievement] §fUnlock this achievement by eating an enchanted golden apple!");
                    break;
            }
        });
        $form->setTitle("MAchievements");
        ...
        if (!$this->plugin->achievement->getNested("achievements.".$player->getName().".sleep")) {
            $form->addButton("§a[ Hoaam.. I Need Rest ]\n§cNot Obtained", 0, "textures/items/red_bed.png");
        } else {
            $form->addButton("§a[ Hoaam.. I Need Rest ]\n§aObtained", 0, "textures/items/red_bed.png");
        }
        # End Sleep
        # Start Gapple
